...
from dlvc.utils import get_datasets, get_api_key, get_entity
...
def train(args):
    ...
    logger = WandBLogger(api_key=get_api_key(), model=model, project_name="training", entity_name=get_entity(), run_name="ResNet")
